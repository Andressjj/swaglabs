...
@AllEscenarios
Característica: Visitas de Certificacion de la capacidad de produccion
  Automatizacion  para validar el correcto funcionamento del tramite.

  Antecedentes:
    Dados los datos del ambiente y usuarios del sistema

  @VisitaCapacidadProduccionCosmeticosNueva
  Escenario: Visita y Certificacion Nueva de la Capacidad de Produccion en Cosmeticos
    ...
    Cuando Selecciono la categoria "Visitas y Certificaciones" y el grupo "Cosméticos"
    Y Selecciono el tipo de tramite "Capacidad de Producc"
  ...
  @VisitaCapacidadProduccionHigieneDomesticaNueva
  Escenario: Visita y Certificacion Nueva de la Capacidad de Produccion en Higiene Domestica
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Y Necesito registrar un tramite nuevo de "Cosméticos, Aseo, Plaguicidas y Productos de Higiene Doméstica"
  ...
  @VisitaCapacidadProduccionHigienePersonalNueva
  Escenario: Visita y Certificacion Nueva de la Capacidad de Produccion en Higiene Personal
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Y Necesito registrar un tramite nuevo de "Cosméticos, Aseo, Plaguicidas y Productos de Higiene Doméstica"
