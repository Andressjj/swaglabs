...
Característica: Visitas de Certificacion de condiciones sanitarias
  ...
  @VisitaCondicionesSanitariasPlaguicidasUsoDomesticoNueva
  Escenario: Visita y Certificacion Nueva Condiciones Sanitarias Plaguicidas Uso Domestico
    ...
    Cuando Selecciono la categoria "Visitas y Certificaciones" y el grupo "Plaguicidas de Uso Doméstico"
    Y Selecciono el tipo de tramite "Condiciones Sanitarias"
