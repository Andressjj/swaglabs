...
Característica: Visitas de Certificacion de condiciones sanitarias
  ...
  @VisitaBuenasPracticasManufacturaCosmeticosNueva
  Escenario: Visita y Certificacion Nueva Buenas Paracticas de Manufactura Cosmeticos
    ...
    Y Selecciono el tipo de tramite "Manufactura"
