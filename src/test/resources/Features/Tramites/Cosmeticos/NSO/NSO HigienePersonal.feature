# language: es
@NSOProductosDeHigienePersonal
@AllScenarios
@NSO
Característica: Notificacion Sanitaria Obligatoria Higiene Personal
  Automatizacion  para validar el correcto funcionamento del tramite.

  Antecedentes:
    Dados los datos del ambiente y usuarios del sistema

  @NSOProductosDeHigienePersonalNueva
  @NSONueva
  Escenario: Notificacion Sanitaria Obligatoria Nueva en Productos Absorbendes de Higiene Personal
    ...
    Y Valido que se muestren los documentos obligatorios y los agrego
  ...
  @CVLCosmeticosNSOHigienePersonalAsociadoAlExpediente
  @CertificadosVentaLibreNSO
  Escenario:  CVL NSO Higiene Personal Asociado al Expediente
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
  ...
  @CertificacionConNSOHigienePersonal
  Escenario: Certificacion con Notificacion Sanitaria Obligatoria Higiene Personal
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Cuando Necesito registrar un tramite asociado a un expediente
    Y Selecciono el tipo de tramite "con NSO"
    Entonces Se muestra la pantalla para asociar una empresa al tramite
    ...
    #Cuando Ingreso toda la informacion de la pantalla tecnica Certificacion con NSO Higiene Personal
    Y Puedo previsualizar el certificado
    Entonces Puedo visualizar la informacion general de la tarifa
  ...
  @ModificacionDeLaInformacionDeLaNSOHigienePersonal
  Escenario: Modificacion de la Informacion de la NSO Cosmeticos
    ...
    Entonces Se muestra la pantalla para asociar una empresa al tramite
    #Y Se muestra la tarifa "4001-23" correspondiente al tramite
  ...
  @NSOHigienePersonalNotificacionAgotamiento
  Escenario:  NSO Higiene Personal Asociado al Expediente Agotamiento
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Y Necesito registrar un tramite asociado a un expediente
  ...
  @NSOHigienePersonalRenovacion
  Escenario:  NSO Higiene Personal Asociado al Expediente Renovacion
     * Tengo la variable "Expediente" con el valor "R000002900"
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Y Necesito registrar un tramite asociado a un expediente
