...
@CertificadoDeExclusivaExportacionNSO
@AllScenarios
@NSO
Característica: Certificado de Exclusiva exportacion
  Automatizacion  para validar el correcto funcionamento del tramite.

  Antecedentes:
    Dados los datos del ambiente y usuarios del sistema

  @CertificadoExclusivaExportacionCosmeticos
  Escenario: Certificado de Exclusiva Exportacion Cosmeticos
    ...
    Cuando Ingreso toda la informacion de la pantalla tecnica Certificado De Exclusiva Exportación
  ...
  @CertificadoExclusivaExportacionHigienePersonal
  Escenario: Certificado de Exclusiva Exportacion Higiene Personal
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Y Necesito registrar un tramite nuevo de "Cosméticos, Aseo, Plaguicidas y Productos de Higiene Doméstica"
    Cuando Selecciono la categoria "Sanitaria Obligatoria" y el grupo "Higiene Pers"
    Y Selecciono el tipo de tramite "Certificado de Exclusiva"
    Entonces Se muestra la pantalla para asociar una empresa al tramite
    Y Se muestran las tarifas correspondientes al tramite
      |4002-3|
  ...
  @CertificadoExclusivaExportacionHigieneDomestica
  Escenario: Certificado de Exclusiva Exportacion Higiene Domestica
    Dado Inicio sesion en "NPTUrl" como "GestorTramites"
    Y Necesito registrar un tramite nuevo de "Cosméticos, Aseo, Plaguicidas y Productos de Higiene Doméstica"
